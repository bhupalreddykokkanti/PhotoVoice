...
//        gridAdapter    =   new ImageGridAdapter(LaunchActivity.this);
//        GridLayoutManager layoutManager= new GridLayoutManager(LaunchActivity.this, 2);
...
//        delayedHide(100);
    ...
    private void showImagePickingOptions() {
        ...
        PickImageDialog.on(getSupportFragmentManager(), setup).setOnClick(new IPickClick() {
            ...
            public void onGalleryClick() {
                Toast.makeText(LaunchActivity.this, "Gallery Click!", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(LaunchActivity.this, AlbumSelectActivity.class);
            ...
            public void onCameraClick() {
                Toast.makeText(LaunchActivity.this, "Camera Click!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == Constants.REQUEST_CODE && resultCode == RESULT_OK && data != null) {
            ...
            Intent in = new Intent(LaunchActivity.this, SelectedImagesActivity.class);
            in.putExtra("listSelectedImages", images);
            startActivity(in);
        }
    }
}
